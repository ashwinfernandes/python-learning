...
class Enemy:
    ...
    def take_damage(self, damage):
        ...
        if remaining_points >= 0:
            ...
            print(f"I took {damage} point damage and have {self._hit_points} left")
        else:
            self._lives -= 1
            if self._lives > 0:
                print(f"{self._name} lost a life")
                self._hit_points = self._original_hit_points
            else:
...
class Troll(Enemy):
    ...
    def __init__(self, name):
        ...
        super().__init__(name=name, lives=1, hit_points=23)  # does the same thing as the previous line
...
class VampyreKing(Vampyre):
    ...
    def __init__(self, name):
        ...
        self._original_hit_points = self._hit_points = 140
