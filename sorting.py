...
numbers.sort() # sorts the original numbers list
...
missing_letter = sorted("The quick brown fox jumped over the lazy dog") # you can also pass string literals to sorted because strings are iterable
